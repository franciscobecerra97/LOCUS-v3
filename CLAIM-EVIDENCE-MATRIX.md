...
| C10 | Provider-neutral public admission resists replay and cross-context reuse | Not part of baseline | D004 local synthetic issuer; subject/audience/bid/epoch/operation/client-key/nonce/issuance/expiry negative tests; independent authorizer/gateway validation; external OIDC adapter evidence only if that optional profile is added |
